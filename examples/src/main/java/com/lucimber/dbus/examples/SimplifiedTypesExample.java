 ...
 *
 * <p>This example demonstrates the new factory methods that simplify creating common D-Bus
 * container types without verbose signature handling.
 */
public class SimplifiedTypesExample {
    ...
    private static void demonstrateArrayFactoryMethods() {
        ...
        // Object path array
        DBusArray<DBusObjectPath> paths =
                DBusArray.ofObjectPaths("/org/example/Object1", "/org/example/Object2");
    ...
    private static void demonstrateDictionaryFactoryMethods() {
        ...
        properties.put(
                DBusString.valueOf("Active"), DBusVariant.valueOf(DBusBoolean.valueOf(true)));
        properties.put(DBusString.valueOf("Count"), DBusVariant.valueOf(DBusInt32.valueOf(42)));
        properties.put(
                DBusString.valueOf("Name"), DBusVariant.valueOf(DBusString.valueOf("Example")));
    ...
    private static void demonstrateJavaConversions() {
        ...
        System.out.println(
                "  Converted Java String map to D-Bus dict: " + dbusStringDict.size() + " entries");
        ...
        System.out.println(
                "  Converted Java Object map to D-Bus variant dict: "
                        + dbusVariantDict.size()
                        + " entries");
