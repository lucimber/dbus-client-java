 ...
 * - Filter signals by interface and member
...
public class SignalHandlingExample {
  ...
  public static void main(String[] args) throws Exception {
    ...
    System.out.println("  Interfaces: " + (config.interfaces.isEmpty() ? "ALL" : config.interfaces));
    ...
    try (Connection connection = NettyConnection.newSystemBusConnection(connectionConfigBuilder.build())) {
      ...
      if (config.mode.equals("demo")) {
        ...
        Runtime.getRuntime().addShutdownHook(new Thread(() -> {
          System.out.println();
          System.out.println("🛑 Shutting down signal monitoring...");
  ...
  private static void showUsage() {
    ...
    System.out.println("  --timeout SECONDS         Monitor signals for specified seconds (default: 60)");
    System.out.println("  --interfaces LIST         Comma-separated list of interfaces to monitor");
    ...
    System.out.println("  SignalHandlingExample --interfaces \"org.freedesktop.NetworkManager,org.freedesktop.UPower\"");
