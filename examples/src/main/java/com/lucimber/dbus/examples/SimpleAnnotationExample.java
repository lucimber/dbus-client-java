 ...
 * 1. Create a D-Bus service using annotations
 * 2. Register it with the StandardInterfaceHandler
 * 3. Test the service using D-Bus tools
 */
public class SimpleAnnotationExample {
  ...
  public static void main(String[] args) throws Exception {
    ...
    try {
      ...
      StandardInterfaceHandler handler = new StandardInterfaceHandler(OBJECT_PATH, calculator);
  ...
  private static void requestServiceName(Connection connection, String serviceName) throws Exception {
    OutboundMethodCall requestName = OutboundMethodCall.Builder
        ...
        .withBody(DBusSignature.valueOf("su"), Arrays.asList(
