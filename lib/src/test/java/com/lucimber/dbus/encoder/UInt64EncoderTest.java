...
final class UInt64EncoderTest {
  ...
  if (byteOrder == ByteOrder.BIG_ENDIAN) {
      expected0 = new byte[]{0x01, 0x23, 0x45, 0x67, (byte) 0x89, (byte) 0xAB, (byte) 0xCD, (byte) 0xEF};
  } else {
      expected0 = new byte[]{(byte) 0xEF, (byte) 0xCD, (byte) 0xAB, (byte) 0x89, 0x67, 0x45, 0x23, 0x01};
  }
  ...
  if (byteOrder == ByteOrder.BIG_ENDIAN) {
      expected1 = new byte[]{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
  ...
  if (byteOrder == ByteOrder.BIG_ENDIAN) {
      expected4 = new byte[]{0x00, 0x00, 0x00, 0x00, 
              0x01, 0x23, 0x45, 0x67, (byte) 0x89, (byte) 0xAB, (byte) 0xCD, (byte) 0xEF};
  } else {
      expected4 = new byte[]{0x00, 0x00, 0x00, 0x00, 
              (byte) 0xEF, (byte) 0xCD, (byte) 0xAB, (byte) 0x89, 0x67, 0x45, 0x23, 0x01};
  ...
  if (byteOrder == ByteOrder.BIG_ENDIAN) {
      expected8 = new byte[]{0x01, 0x23, 0x45, 0x67, (byte) 0x89, (byte) 0xAB, (byte) 0xCD, (byte) 0xEF};
  } else {
      expected8 = new byte[]{(byte) 0xEF, (byte) 0xCD, (byte) 0xAB, (byte) 0x89, 0x67, 0x45, 0x23, 0x01};
  }
  ...
  if (byteOrder == ByteOrder.BIG_ENDIAN) {
      expected4294967295 = new byte[]{0x00, 0x00, 0x00, 0x00, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF};
  } else {
      expected4294967295 = new byte[]{(byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, 0x00, 0x00, 0x00, 0x00};
  }
  ...
  assertEquals(8, resultMaxLong.getProducedBytes(), "Value Long.MAX_VALUE: " + PRODUCED_BYTES);
  byte[] expectedMaxLong, actualMaxLong = new byte[8];
  resultMaxLong.getBuffer().get(0, actualMaxLong);
  if (byteOrder == ByteOrder.BIG_ENDIAN) {
      expectedMaxLong = new byte[]{0x7F, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF};
  } else {
      expectedMaxLong = new byte[]{(byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, 0x7F};
  }
  ...
  EncoderResult<ByteBuffer> result18446744073709551614 = encoder.encode(value18446744073709551614, 0);
  assertEquals(8, result18446744073709551614.getProducedBytes(), "Value 18446744073709551614: " + PRODUCED_BYTES);
  ...
  if (byteOrder == ByteOrder.BIG_ENDIAN) {
      expected18446744073709551614 = new byte[]{(byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFE};
  } else {
      expected18446744073709551614 = new byte[]{(byte) 0xFE, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF};
  }
  assertArrayEquals(expected18446744073709551614, actual18446744073709551614, byteOrder + " Value 18446744073709551614");
  }
