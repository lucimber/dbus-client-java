...
class ConnectionStrategyRegistryTest {
  ...
  unavailableStrategy = new MockConnectionStrategy("Unavailable", DomainSocketAddress.class, false);
  }
  ...
  MockConnectionStrategy(String name, Class<? extends SocketAddress> supportedType, boolean available) {
      this.name = name;
