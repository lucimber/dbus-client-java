...
class InternalContextTest {
  ...
  InternalContext outboundCtx = new InternalContext(mockConnection, pipeline, "out", outboundHandler);
  OutboundMessage msg = Mockito.mock(OutboundMessage.class);
  CompletableFuture<Void> future = new CompletableFuture<>();
  ...
  InternalContext eventCtx = new InternalContext(mockConnection, pipeline, "evt", genericHandler);
