...
final class DictionaryEncoderTest {
    ...
    void encodeEmptySimpleDictionary(ByteOrder byteOrder) {
        ...
        DictEncoder<DBusString, DBusBoolean> encoder = new DictEncoder<>(byteOrder, signature);
    ...
    void encodeEmptyComplexDictionary(ByteOrder byteOrder) {
        ...
        DBusDict<DBusObjectPath, DBusDict<DBusString, DBusVariant>> dict =
    ...
    void encodeComplexDictionary(ByteOrder byteOrder) {
        ...
        innerDict.put(
                DBusString.valueOf("Handle"), DBusVariant.valueOf(DBusUInt16.valueOf((short) 1)));
        innerDict.put(
                DBusString.valueOf("Primary"), DBusVariant.valueOf(DBusBoolean.valueOf(true)));
        innerDict.put(
                DBusString.valueOf("UUID"),
                DBusVariant.valueOf(DBusString.valueOf("0000180a-0000-1000-8000-00805f9b34fb")));
        sDict.put(iGattService, innerDict);
        dict.put(sPath, sDict);
        DictEncoder<DBusObjectPath, DBusDict<DBusString, DBusDict<DBusString, DBusVariant>>>
                encoder = new DictEncoder<>(byteOrder, signature);
        EncoderResult<ByteBuffer> result = encoder.encode(dict, 0);
