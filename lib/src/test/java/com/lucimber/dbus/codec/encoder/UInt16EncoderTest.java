...
final class UInt16EncoderTest {
    ...
    void encodeUnsignedShortHighValues(ByteOrder byteOrder) {
        ...
        DBusUInt16 value32768 =
                DBusUInt16.valueOf((short) 32768); // -32768 as signed = 32768 as unsigned
        ...
        DBusUInt16 value65534 =
                DBusUInt16.valueOf((short) 65534); // -2 as signed = 65534 as unsigned
