...
/**
 * Integration tests for D-Bus message handling including method calls, returns, errors, and complex
 * data types.
 */
@Tag("integration")
...
class MessageHandlingIntegrationTest extends DBusIntegrationTestBase {
    ...
    private static final Logger LOGGER =
            LoggerFactory.getLogger(MessageHandlingIntegrationTest.class);
            ...
            OutboundMethodCall nameHasOwner =
                    OutboundMethodCall.Builder.create()
                            ...
                            .withBody(
                                    ...
                                    List.of(DBusString.valueOf("org.freedesktop.DBus")))
                            .withReplyExpected(true)
                            .build();
    ...
    void testMessageSerialization() throws Exception {
        ...
        try {
            // Test that messages can be sent (but not expecting responses since sendRequest is not
            // implemented)
    ...
    void testConnectionSerialNumberGeneration() throws Exception {
        ...
        try {
            ...
            LOGGER.info(
                    "✓ Serial number generation working correctly: {}, {}, {}",
                    serial1.longValue(),
                    serial2.longValue(),
                    serial3.longValue());
