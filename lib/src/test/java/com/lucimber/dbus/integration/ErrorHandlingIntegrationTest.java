...
class ErrorHandlingIntegrationTest extends DBusIntegrationTestBase {
    ...
    void testErrorMessageCreation() throws Exception {
        ...
        try {
            ...
            assertEquals(
                    "com.example.NonExistentService",
                    invalidCall.getDestination().get().toString());
    ...
    void testInvalidParameterMessageCreation() throws Exception {
        ...
        try {
                    ...
                    OutboundMethodCall.Builder.create()
                            ...
                            .withPath(
                                    DBusObjectPath.valueOf(
                                            "/org/freedesktop/DBus/NonExistentObject"))
                            .withMember(DBusString.valueOf("TestMethod"))
            ...
            assertEquals(
                    "/org/freedesktop/DBus/NonExistentObject",
                    invalidCall.getObjectPath().toString());
            assertEquals("TestMethod", invalidCall.getMember().toString());
            assertEquals(
                    "org.freedesktop.DBus.TestInterface",
        ...
        try {
            ...
            OutboundMethodCall invalidCall =
                    OutboundMethodCall.Builder.create()
                            ...
                            .withBody(
                                    DBusSignature.valueOf("u"),
                                    List.of(
                                            com.lucimber.dbus.type.DBusUInt32.valueOf(
                                                    12345))) // Should be "s" (string), not "u"
                            // (uint32)
                            .withReplyExpected(true)
                            .build();
        ...
        Connection connection =
                new NettyConnection(
                        new InetSocketAddress(
                                "192.0.2.1", 12345), // RFC5737 test address (unreachable)
                        config);
    ...
    void testInvalidServiceNameMessages() throws Exception {
        ...
        try {
            ...
            OutboundMethodCall invalidRequest =
                    OutboundMethodCall.Builder.create()
                            .withSerial(connection.getNextSerial())
                            .withPath(DBusObjectPath.valueOf("/org/freedesktop/DBus"))
    ...
    void testRestrictedMethodMessages() throws Exception {
        ...
        try {
            ...
            OutboundMethodCall restrictedCall =
                    OutboundMethodCall.Builder.create()
                            .withSerial(connection.getNextSerial())
                            .withPath(DBusObjectPath.valueOf("/org/freedesktop/DBus"))
                            ...
                            .withInterface(DBusString.valueOf("org.freedesktop.DBus"))
                            .withBody(
                                    DBusSignature.valueOf("a{ss}"),
                                    List.of(
                                            new com.lucimber.dbus.type.DBusDict<>(
                                                    DBusSignature.valueOf("a{ss}")) // Empty dict
                                            ))
                            .withReplyExpected(true)
                            .build();
        ...
        try {
            ...
            if (healthCheckEnabled) {
                ...
                LOGGER.info(
                        ...
                        connection.getConfig().getHealthCheckInterval());
            }
            ...
            OutboundMethodCall largeCall =
                    OutboundMethodCall.Builder.create()
                            ...
                            .withBody(
                                    ...
                                    List.of(DBusString.valueOf(largeString.toString())))
                            .withReplyExpected(true)
                            .build();
