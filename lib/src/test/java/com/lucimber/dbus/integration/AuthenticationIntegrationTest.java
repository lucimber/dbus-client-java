...
class AuthenticationIntegrationTest extends DBusIntegrationTestBase {
    ...
    private static final Logger LOGGER =
            LoggerFactory.getLogger(AuthenticationIntegrationTest.class);
    ...
    void testExternalAuthenticationUnixSocket() throws Exception {
        ...
        Connection connection =
                new NettyConnection(new DomainSocketAddress("/tmp/dbus-test-socket"), config);
        ...
        try {
            ...
            LOGGER.warn(
                    "External authentication test failed (may be expected): {}", e.getMessage());
