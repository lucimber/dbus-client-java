...
class AbstractExceptionTest {
    ...
    void testNullErrorNameThrowsException() {
        ...
        assertThrows(NullPointerException.class, () -> new TestException(null, DBusString.valueOf("message")));
        assertThrows(NullPointerException.class, () -> new TestException(null, new RuntimeException()));
        assertThrows(NullPointerException.class, () -> new TestException(null, DBusString.valueOf("message"), new RuntimeException()));
    }
}