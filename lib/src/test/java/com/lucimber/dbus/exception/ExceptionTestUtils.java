...
class ExceptionTestUtils {
    ...
    static <T extends AbstractException> void testExceptionClass(
            Class<T> exceptionClass, String expectedErrorName) {
        try {
            ...
            Constructor<T> fullConstructor =
                    exceptionClass.getConstructor(DBusString.class, Throwable.class);
            ...
            fail(
                    "Failed to test exception class "
