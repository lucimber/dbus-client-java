...
final class DBusDoubleTest {
    ...
    @ParameterizedTest
    @ValueSource(doubles = {0.0, 1.0, -1.0, 123.456, -123.456, 1.7976931348623157E308, 4.9E-324, 
                           Math.PI, Math.E, 1.23456789012345E-100, 1.23456789012345E100})
    ...
    void testPrecisionAndAccuracy() {
        ...
        for (double value : precisionTests) {
            DBusDouble dbusDouble = DBusDouble.valueOf(value);
            assertEquals(value, dbusDouble.doubleValue(), 0.0,
                "Precision lost for value: " + value);
        }
    }
