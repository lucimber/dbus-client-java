...
final class DBusDictEntryTest {
    ...
    void testEqualsWithNullValues() {
        ...
        DBusDictEntry<DBusString, DBusInt32> entry3 =
                new DBusDictEntry<>(signature, key, DBusInt32.valueOf(42));
    ...
    void testHashCode() {
        ...
        DBusDictEntry<DBusString, DBusInt32> entry3 =
                new DBusDictEntry<>(signature, key, DBusInt32.valueOf(123));
    ...
    void testWithComplexValueTypes() {
        ...
        DBusStruct structValue =
                new DBusStruct(structSig, DBusInt32.valueOf(10), DBusInt32.valueOf(20));
    ...
    void testWithAllBasicKeyTypes() {
        ...
        DBusDictEntry<DBusInt16, DBusInt32> int16Entry =
                new DBusDictEntry<>(
                        int16Sig, DBusInt16.valueOf((short) 1000), DBusInt32.valueOf(1000));
        ...
        DBusDictEntry<DBusUInt16, DBusInt32> uint16Entry =
                new DBusDictEntry<>(
                        uint16Sig, DBusUInt16.valueOf((short) 60000), DBusInt32.valueOf(60000));
        ...
        DBusDictEntry<DBusUInt32, DBusInt32> uint32Entry =
                new DBusDictEntry<>(
                        uint32Sig, DBusUInt32.valueOf((int) 4000000000L), DBusInt32.valueOf(1));
        ...
        DBusDictEntry<DBusInt64, DBusInt32> int64Entry =
                new DBusDictEntry<>(
                        int64Sig, DBusInt64.valueOf(9000000000000000L), DBusInt32.valueOf(1));
        ...
        DBusDictEntry<DBusObjectPath, DBusInt32> objectPathEntry =
                new DBusDictEntry<>(
                        objectPathSig,
                        DBusObjectPath.valueOf("/com/example"),
                        DBusInt32.valueOf(1));
    ...
    void testDBusSpecificationCompliance() {
        ...
        DBusDictEntry<DBusString, DBusInt32> entry =
                new DBusDictEntry<>(validSignature, key, value);
        assertEquals(Type.DICT_ENTRY, entry.getType());
