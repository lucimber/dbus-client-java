...
final class DBusUInt64Test {
    ...
    void testPowerOfTwoBoundaries() {
        ...
        long[] powerOfTwoBoundaries = {
            ...
            1152921504606846976L, 2305843009213693952L, 4611686018427387904L, Long.MIN_VALUE // 2^63
        };
    ...
    void testCommonValues() {
        ...
        long[] commonValues = {
            0L, 1L, 10L, 100L, 1000L, 10000L, 100000L, 1000000L, 10000000L, 100000000L, 1000000000L,
            42L, 123L, 255L, 256L, 999L, 1024L, 2020L, 12345L, 65535L, 65536L, 4294967295L, 4294967296L,
            Long.MAX_VALUE, Long.MIN_VALUE, -1L, -2L, -100L, -1000L
        };
