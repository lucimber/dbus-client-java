...
final class DBusStructTest {
  ...
  void testWithVariousBasicTypes() {
    ...
    DBusStruct struct = new DBusStruct(signature, byteVal, boolVal, int16Val, uint16Val, 
                                          int32Val, uint32Val, int64Val, uint64Val, doubleVal, 
                                          unixFdVal, stringVal, objectPathVal, sigVal);
  ...
  void testComplexNestedStructures() {
    ...
    List<DBusType> arrayElements = Arrays.asList(
  ...
  void testStructWithArrays() {
    ...
    List<DBusType> intElements = Arrays.asList(
      DBusInt32.valueOf(1), DBusInt32.valueOf(2), DBusInt32.valueOf(3)
    );
    ...
    List<DBusType> byteElements = Arrays.asList(
      DBusByte.valueOf((byte) 10), DBusByte.valueOf((byte) 20), DBusByte.valueOf((byte) 30)
    );
