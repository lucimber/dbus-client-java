...
final class DBusSignatureTest {
    ...
    public void testInvalidSignatures() {
        ...
        assertThrows(
                Exception.class, () -> DBusSignature.valueOf("a")); // Array without element type
        ...
        assertThrows(
                Exception.class, () -> DBusSignature.valueOf("(i")); // Unclosed struct with element
        assertThrows(
                Exception.class, () -> DBusSignature.valueOf("i)")); // Unopened struct with element
        ...
        assertThrows(
                Exception.class, () -> DBusSignature.valueOf("{{")); // Nested unclosed dict entry
        assertThrows(
                Exception.class, () -> DBusSignature.valueOf("{i")); // Unclosed dict entry with key
        assertThrows(
                Exception.class, () -> DBusSignature.valueOf("i}")); // Unopened dict entry with key
        assertThrows(
                Exception.class,
                () -> DBusSignature.valueOf("a{i}")); // Dict entry with one element
        assertThrows(
                Exception.class,
                () -> DBusSignature.valueOf("a{iii}")); // Dict entry with three elements
    ...
    public void testDictEntryKeyRestrictions() {
        ...
        assertThrows(
                SignatureException.class, () -> DBusSignature.valueOf("a{(ii)s}")); // struct key
        assertThrows(
                SignatureException.class, () -> DBusSignature.valueOf("a{a{sv}s}")); // array key
    ...
    public void testExcessiveNestingDepth() {
        ...
        // Test with 33 array nesting levels (per D-Bus spec should fail, but implementation may
        // allow)
        ...
        // Test with 33 struct nesting levels (per D-Bus spec should fail, but implementation may
        // allow)
    ...
    public void testDictEntryBasicKeyRestriction() {
        ...
        for (String keyType : invalidKeyTypes) {
            String dictSignature = "a{" + keyType + "s}";
            assertThrows(SignatureException.class, () -> DBusSignature.valueOf(dictSignature));
        }
    }
    ...
    public void testSignatureComponentValidation() {
        ...
        for (String reservedType : reservedTypes) {
            assertThrows(IllegalArgumentException.class, () -> DBusSignature.valueOf(reservedType));
        }
    }
