...
final class DBusArrayTest {
    ...
    void testAddAll() {
        ...
        List<DBusInt32> values = Arrays.asList(
            DBusInt32.valueOf(1), DBusInt32.valueOf(2), DBusInt32.valueOf(3)
        );
        ...
        List<DBusInt32> moreValues = Arrays.asList(
    ...
    void testArrayOfStructs() {
        ...
        DBusStruct struct1 = new DBusStruct(structSig, DBusInt32.valueOf(1), DBusString.valueOf("one"));
        DBusStruct struct2 = new DBusStruct(structSig, DBusInt32.valueOf(2), DBusString.valueOf("two"));
    ...
    void testArrayStreaming() {
        ...
        long evenCount = array.stream()
            .filter(value -> value.intValue() % 2 == 0)
            .count();
        
        assertEquals(5, evenCount);
        
        // Test parallel stream
        int sum = array.parallelStream()
            .mapToInt(DBusInt32::intValue)
            .sum();
