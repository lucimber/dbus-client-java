...
final class UInt16Test {
    ...
    void testMaxUnsignedValue() {
        ...
        // Note: toString() behavior depends on implementation - may return string representation of signed value
    ...
    void testNumberMethodsWithLargeValues() {
        ...
        assertEquals((short) 40000, uint16.shortValue()); // This will be negative when cast to short
    }
