...
final class DBusObjectPathValidationTest {
    ...
    void rejectPathWithNulCharacters() {
        ObjectPathException ex =
                assertThrows(
                        ObjectPathException.class, () -> DBusObjectPath.valueOf("/test\u0000path"));
    ...
    void rejectPathsWithTrailingSlash() {
        ObjectPathException ex =
                assertThrows(
                        ObjectPathException.class, () -> DBusObjectPath.valueOf("/valid/path/"));
    ...
    void rejectPathsNotStartingWithSlash() {
        ObjectPathException ex =
                assertThrows(ObjectPathException.class, () -> DBusObjectPath.valueOf("invalid"));
    ...
    void rejectOversizedPath() {
        ...
        ObjectPathException ex =
                assertThrows(
                        ObjectPathException.class, () -> DBusObjectPath.valueOf(sb.toString()));
    ...
    void validateComplexValidPaths() {
        ...
        for (String path : validPaths) {
            assertDoesNotThrow(
                    () -> DBusObjectPath.valueOf(path), "Failed for valid path: " + path);
        }
    }
