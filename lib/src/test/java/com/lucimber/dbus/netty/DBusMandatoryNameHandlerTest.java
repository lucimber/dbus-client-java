...
class DBusMandatoryNameHandlerTest {
  ...
  void testPassesThroughUnrelatedMessages() {
    ...
    InboundMethodReturn unrelatedReply = InboundMethodReturn.Builder.create()
        .withSerial(DBusUInt32.valueOf(999))
        .withReplySerial(DBusUInt32.valueOf(888)) // Different from hello call serial
        .withSender(SENDER)
        .withBody(DBusSignature.valueOf("s"), List.of(DBusString.valueOf("unrelated")))
        .build();
  ...
  void testHelloCallParameters() {
    ...
    assertEquals(DBusString.valueOf("org.freedesktop.DBus"), helloCall.getInterfaceName().get());
  ...
  void testHelloErrorWithPayload() {
    ...
    InboundError error = InboundError.Builder.create()
        ...
        .withReplySerial(sentSerial)
        .withSender(SENDER)
        .withErrorName(DBusString.valueOf("org.freedesktop.DBus.Error.AccessDenied"))
        .withBody(DBusSignature.valueOf("s"), List.of(DBusString.valueOf("Access denied")))
        .build();
  ...
  void testUnrelatedErrorPassedThrough() {
    ...
    InboundError unrelatedError = InboundError.Builder.create()
        .withSerial(DBusUInt32.valueOf(999))
        .withReplySerial(DBusUInt32.valueOf(888)) // Different from hello call serial
        .withSender(SENDER)
        .withErrorName(DBusString.valueOf("org.freedesktop.DBus.Error.UnknownMethod"))
        .build();
