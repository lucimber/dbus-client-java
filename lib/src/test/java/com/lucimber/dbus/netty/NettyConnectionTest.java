...
class NettyConnectionTest {
    ...
    @Mock
    private ConnectionHandle mockHandle;
    @Mock
    ...
    void testConstructorWithAddress() {
        ...
        assertEquals(ConnectionConfig.defaultConfig().getConnectTimeout(), connection.getConfig().getConnectTimeout());
    ...
    void testNewSystemBusConnectionDefault() {
        ...
        assertEquals(ConnectionConfig.defaultConfig().getConnectTimeout(), systemConn.getConfig().getConnectTimeout());
    }
    ...
    void testNewSessionBusConnectionWithConfig() {
        ...
        // Since DBUS_SESSION_BUS_ADDRESS is not set in test environment
        assertThrows(IllegalStateException.class, () -> NettyConnection.newSessionBusConnection(config));
    }
    ...
    void testSendRequestWhenNotConnected() {
        ...
        OutboundMessage msg = OutboundMethodCall.Builder.create()
