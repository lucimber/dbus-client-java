...
final class OutboundMessageEncoderTest {
  ...
  void testEncodeMethodCall() {
    ...
    List<DBusType> payload = Arrays.asList(
        DBusString.valueOf("arg1"),
        DBusUInt32.valueOf(42)
    );
    DBusSignature signature = DBusSignature.valueOf("su");

    OutboundMethodCall methodCall = OutboundMethodCall.Builder.create()
        .withSerial(serial)
  ...
  void testEncodeMethodReturn() {
    ...
    OutboundMethodReturn methodReturn = OutboundMethodReturn.Builder.create()
        .withSerial(serial)
  ...
  void testEncodeSignal() {
    ...
    List<DBusType> payload = Arrays.asList(
        DBusString.valueOf("signal_data"),
        DBusUInt32.valueOf(999)
    );
    DBusSignature signature = DBusSignature.valueOf("su");
  ...
  void testAllMessageTypes() {
    ...
    List<Class<?>> messageTypes = Arrays.asList(
    ...
    for (Class<?> messageType : messageTypes) {
      ...
      if (messageType == OutboundMethodCall.class) {
        OutboundMethodCall msg = OutboundMethodCall.Builder.create()
        ...
        OutboundMethodReturn msg = OutboundMethodReturn.Builder.create()
            .withSerial(DBusUInt32.valueOf(1))
        ...
        OutboundError msg = OutboundError.Builder.create()
            .withSerial(DBusUInt32.valueOf(1))
            .withReplySerial(DBusUInt32.valueOf(2))
        ...
        OutboundSignal msg = OutboundSignal.Builder.create()
            .withSerial(DBusUInt32.valueOf(1))
