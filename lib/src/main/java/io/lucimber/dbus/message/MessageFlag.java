...
public enum MessageFlag {
     ...
     * <p>
     * Note that METHOD_CALL is the only message type currently defined
     ...
     * <p>
     * Interaction that takes place as a part of the effect of the method being called
     ...
     * <p>
     * If a this flag is not set on a method call, and a service determines that the requested operation
     ...
     * <p>
     * The absence of this flag does not guarantee that interactive authorization will not be applied,
