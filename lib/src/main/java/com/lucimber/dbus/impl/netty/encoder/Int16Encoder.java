 ...
 * @see Int16
 */
public final class Int16Encoder implements Encoder<Int16, ByteBuf> {
   ...
   */
  public Int16Encoder(final ByteBufAllocator allocator, final ByteOrder order) {
  ...
  private static void logResult(final Int16 value, final int offset, final int padding,
    ...
    LoggerUtils.debug(LOGGER, MARKER, () -> {
      final String s = "INT16: %s; Offset: %d; Padding: %d; Produced bytes: %d;";
      return String.format(s, value, offset, padding, producedBytes);
    });
  }

  @Override
  public EncoderResult<ByteBuf> encode(final Int16 value, final int offset) throws EncoderException {
