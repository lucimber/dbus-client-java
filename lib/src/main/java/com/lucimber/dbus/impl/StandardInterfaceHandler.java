...
import com.lucimber.dbus.annotation.DBusSignal;
 ...
 * 
 * <p>This handler automatically provides implementations for:</p>
 * <ul>
 *   <li>org.freedesktop.DBus.Introspectable - generates XML from annotations</li>
 *   <li>org.freedesktop.DBus.Properties - accesses annotated properties</li>
 *   <li>org.freedesktop.DBus.Peer - standard implementation</li>
 * </ul>
 * 
 * <p>Example usage:</p>
 * <pre>{@code
    ...
    switch (memberName) {
      case "Get":
        if (args.size() >= 2) {
          ...
          sendError(ctx, call, "org.freedesktop.DBus.Error.InvalidArgs",
      ...
      case "GetAll":
        if (!args.isEmpty()) {
          ...
          try {
            ...
            DBusDict<DBusString, DBusVariant> result = new DBusDict<>(DBusSignature.valueOf("a{sv}"));
            ...
            sendError(ctx, call, "org.freedesktop.DBus.Error.Failed",
    ...
    if (interfaceName != null) {
      ...
      if (ifaceProps != null) {
        for (String propName : ifaceProps.keySet()) {
          xml.append("    <property name=\"").append(propName)
