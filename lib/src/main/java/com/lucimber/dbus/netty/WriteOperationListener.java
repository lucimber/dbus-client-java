 ...
 * <ul>
 *   <li><strong>DEBUG</strong> - Successful operations</li>
...
public final class WriteOperationListener<T extends Future<?>> implements GenericFutureListener<T> {
   ...
   * <ul>
   *   <li>If the operation was successful, logs at DEBUG level</li>
  ...
  public void operationComplete(T future) {
    if (future.isSuccess()) {
      ...
      logger.error(LoggerUtils.TRANSPORT, "I/O operation was completed with failure.", future.cause());
