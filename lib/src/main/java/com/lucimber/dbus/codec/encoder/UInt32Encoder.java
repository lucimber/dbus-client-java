...
/**
 * An encoder which encodes an unsigned 32-bit integer to the D-Bus marshalling format using
 * ByteBuffer.
 *
 * @see Encoder
 * @see DBusUInt32
...
public final class UInt32Encoder implements Encoder<DBusUInt32, ByteBuffer> {
    ...
    public EncoderResult<ByteBuffer> encode(DBusUInt32 value, int offset) throws EncoderException {
        ...
        try {
            int padding =
                    EncoderUtils.calculateAlignmentPadding(Type.UINT32.getAlignment(), offset);
