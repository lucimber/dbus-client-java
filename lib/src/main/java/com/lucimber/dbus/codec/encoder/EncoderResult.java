...
/**
 * The EncoderResult class yields the encoded D-Bus data type and the number of encoded bytes. The
 * number of encoded bytes is necessary for the calculation of the alignment padding.
 *
