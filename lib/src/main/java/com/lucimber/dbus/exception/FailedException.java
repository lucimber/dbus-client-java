 ...
 * This error name should be avoided, in favor of a more expressive error name.
 */
public final class FailedException extends AbstractException {

  private static final DBusString ERROR_NAME = DBusString.valueOf("org.freedesktop.DBus.Error.Failed");
