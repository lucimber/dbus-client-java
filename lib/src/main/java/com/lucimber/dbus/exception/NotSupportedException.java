...
public final class NotSupportedException extends AbstractException {
  ...
  private static final DBusString ERROR_NAME = DBusString.valueOf("org.freedesktop.DBus.Error.NotSupported");
   ...
   */
  public NotSupportedException(final DBusString message) {
   ...
   * @param cause   the cause
   */
  public NotSupportedException(final DBusString message, final Throwable cause) {
