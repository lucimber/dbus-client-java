...
public final class PropertyReadOnlyException extends AbstractException {
  ...
  private static final DBusString ERROR_NAME = DBusString.valueOf("org.freedesktop.DBus.Error.PropertyReadOnly");
   ...
   */
  public PropertyReadOnlyException(final DBusString message) {
   ...
   */
  public PropertyReadOnlyException(final Throwable cause) {
   ...
   * @param cause   the cause
   */
  public PropertyReadOnlyException(final DBusString message, final Throwable cause) {
