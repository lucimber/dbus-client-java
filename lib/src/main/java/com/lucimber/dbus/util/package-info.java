 ...
 * D-Bus client library. These utilities handle tasks like byte manipulation, string processing,
 ...
 * However, {@link LoggerUtils} can be helpful for debugging, and {@link ByteBufferPoolManager} is
 ...
 *
 * <ul>
 *   <li><strong>Null Safety:</strong> All utility methods handle null inputs gracefully
 *   <li><strong>Immutability:</strong> Utility classes are stateless and thread-safe
 *   <li><strong>Performance:</strong> Utilities are optimized for common use cases
 *   <li><strong>Validation:</strong> Input validation is performed where appropriate
 *   <li><strong>Documentation:</strong> All utilities are thoroughly documented
 * </ul>
 *
 * <h2>Internal Use</h2>
 *
 * <p>While this package is primarily for internal framework use, some utilities may be useful for
 * application developers. However, these utilities are not part of the public API and may change
 * between versions.
 *
