...
public enum MessageType {
  ...
  MessageType(String customName, int decimalCode) {
   ...
   */
  public static MessageType fromString(String customName) {
   ...
   * @return a {@link MessageType}.
   */
  public static MessageType fromDecimalCode(int decimalCode) {
