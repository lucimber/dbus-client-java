 ...
 *
 * <p>Flags correspond to individual bits in the message header's "flags" byte.
 *
 * @see <a
 *     href="https://dbus.freedesktop.org/doc/dbus-specification.html#message-protocol-flags">D-Bus
 *     Specification: Message Flags</a>
 * @since 1.0
 */
