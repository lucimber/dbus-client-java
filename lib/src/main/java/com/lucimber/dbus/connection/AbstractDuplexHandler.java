 ...
 *
 * <p>Subclasses can override one or both sets of handler methods to implement custom logic for
 * inbound and outbound processing. This class is useful for handlers that need to observe or
 * manipulate both directions of message flow.
 *
