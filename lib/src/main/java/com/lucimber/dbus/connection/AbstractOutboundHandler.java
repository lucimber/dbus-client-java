 ...
 *
 * <p>Extend this class to simplify the creation of handlers that only need to process outbound
 * messages and optionally react to connection or pipeline events.
 *
 * @see OutboundHandler
 * @see Context
 * @see Pipeline
