 ...
 *
 * <p>Inbound handlers are responsible for handling messages and failures as they travel from the
 * head to the tail of the pipeline.
 *
 * @see Context
 * @see Pipeline
 */
public interface InboundHandler extends Handler {
     ...
     *
     * <p>Handlers may inspect, transform, or act upon the message before forwarding it downstream.
     *
     * @param ctx the {@link Context} this handler is bound to.
