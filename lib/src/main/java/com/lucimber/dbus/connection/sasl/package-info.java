 ...
 *
 * <p>This package provides a complete SASL framework for D-Bus authentication, supporting multiple
 * authentication mechanisms and secure credential exchange. Authentication is performed
 ...
 * authentication, create a {@link SaslAuthConfig} and pass it to {@link
 * com.lucimber.dbus.connection.ConnectionConfig}. The default EXTERNAL mechanism works for most
 * Unix/Linux systems.
 *
 ...
 *
 * <ol>
 *   <li><strong>Mechanism Selection:</strong> Client and server negotiate authentication mechanism
 *   <li><strong>Challenge Exchange:</strong> Multi-step challenge-response authentication
 *   <li><strong>Credential Validation:</strong> Server validates client credentials
 *   <li><strong>Authentication Success:</strong> Secure communication channel established
 * </ol>
 *
 * <pre>{@code
 ...
 *
 * <ul>
 *   <li><strong>Mechanism Caching:</strong> Authentication mechanisms are cached after first use
 *   <li><strong>Credential Caching:</strong> Credentials are cached for connection reuse
 *   <li><strong>Timeout Optimization:</strong> Authentication timeouts are configurable
 *   <li><strong>Async Processing:</strong> Authentication is performed asynchronously
 * </ul>
 *
 * <pre>{@code
 ...
 *
 * <ul>
 *   <li><strong>Mechanism Selection:</strong> Use EXTERNAL for local connections, DBUS_COOKIE_SHA1
 *       for remote
 *   <li><strong>Credential Security:</strong> Clear credentials from memory after use
 *   <li><strong>Error Handling:</strong> Handle authentication failures gracefully
 *   <li><strong>Timeout Configuration:</strong> Set appropriate authentication timeouts
 *   <li><strong>Debugging:</strong> Enable SASL debugging for troubleshooting
 *   <li><strong>Cookie Management:</strong> Ensure proper cookie file permissions
 * </ul>
 *
 * <h2>Compatibility</h2>
 *
 ...
 *
 * <ul>
 *   <li>D-Bus specification SASL requirements
 *   <li>Standard D-Bus daemons (dbus-daemon, systemd)
 *   <li>Cross-platform D-Bus implementations
 *   <li>Both system and session bus authentication
 * </ul>
 *
