 ...
 *
 * <p>Typically implemented by {@link Context} instances or internal pipeline elements, this
 * interface allows application-specific events to traverse the pipeline toward the tail.
 *
 * @see Context
 * @see Pipeline
 */
public interface UserEventPropagator {
     ...
     *
     * <p>If not intercepted, the event will eventually reach the tail handler.
     *
