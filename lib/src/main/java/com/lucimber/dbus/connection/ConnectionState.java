 ...
 *   <li>{@link #AUTHENTICATING} - SASL authentication in progress</li>
 *   <li>{@link #CONNECTED} - Connected and operational</li>
 *   <li>{@link #UNHEALTHY} - Connected but health checks are failing</li>
 *   <li>{@link #RECONNECTING} - Attempting to reconnect after failure</li>
 *   <li>{@link #FAILED} - Connection failed and cannot be recovered</li>
 * </ul>
 */
public enum ConnectionState {
   ...
   * D-Bus name has been acquired and the connection is ready for use.
   */
  CONNECTED,
  
  /**
   * Connection exists but health checks are failing.
   * The connection may still work but is considered unreliable.
   */
  UNHEALTHY,
