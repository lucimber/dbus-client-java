...
/**
 * The context object that wraps a {@link Handler} and links it into the {@link Pipeline}. It
 * provides methods to interact with and propagate events through the pipeline.
 */
