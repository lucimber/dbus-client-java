 ...
 *
 * <p>This package implements the complete D-Bus type system as Java wrapper classes that ensure
 * type safety and prevent marshalling errors. All D-Bus types are represented as immutable Java
 * objects that can be safely used across threads.
 *
 * <h2>Getting Started</h2>
 *
 * <p><strong>For first-time users:</strong> Start with common types like {@link DBusString}, {@link
 * DBusInt32}, and {@link DBusBoolean}. For paths use {@link DBusObjectPath}, and for collections
 * use {@link DBusArray} and {@link DBusDict}. All types use static factory methods like {@code
 * DBusString.valueOf("hello")}.
 *
 * <h2>Type Hierarchy</h2>
 *
 * <p>All D-Bus types implement the {@link DBusType} interface and are organized into two main
 * categories:
 *
 ...
 *
 * <ul>
 *   <li>{@link DBusByte} - 8-bit unsigned integer (0-255)
 *   <li>{@link DBusBoolean} - Boolean value (true/false)
 *   <li>{@link DBusInt16} - 16-bit signed integer
 *   <li>{@link DBusUInt16} - 16-bit unsigned integer
 *   <li>{@link DBusInt32} - 32-bit signed integer
 *   <li>{@link DBusUInt32} - 32-bit unsigned integer
 *   <li>{@link DBusInt64} - 64-bit signed integer
 *   <li>{@link DBusUInt64} - 64-bit unsigned integer
 *   <li>{@link DBusDouble} - IEEE 754 double-precision floating point
 *   <li>{@link DBusString} - UTF-8 text string
 *   <li>{@link DBusObjectPath} - D-Bus object path
 *   <li>{@link DBusSignature} - D-Bus type signature
 *   <li>{@link DBusUnixFD} - Unix file descriptor
 * </ul>
 *
 ...
 *
 * <ul>
 *   <li>{@link DBusArray} - Homogeneous array of elements
 *   <li>{@link DBusStruct} - Heterogeneous structure (like a tuple)
 *   <li>{@link DBusDict} - Key-value dictionary/map
 *   <li>{@link DBusDictEntry} - Single dictionary entry
 *   <li>{@link DBusVariant} - Dynamically typed value
 * </ul>
 *
 ...
 *
 * <ul>
 *   <li><strong>String validation:</strong> Strings must be valid UTF-8 and not contain NUL
 *       characters
 *   <li><strong>Object path validation:</strong> Object paths must follow D-Bus naming conventions
 *   <li><strong>Signature validation:</strong> Type signatures must be syntactically correct
 *   <li><strong>Size limits:</strong> Arrays and strings have maximum size limits (64MB for arrays,
 *       256MB for strings)
 *   <li><strong>Alignment requirements:</strong> Data is properly aligned according to D-Bus
 *       specification
 * </ul>
 *
 ...
 *
 * <ul>
 *   <li>Once created, type instances cannot be modified
 *   <li>Container types provide defensive copies when needed
 *   <li>All operations are safe for concurrent access
 *   <li>No synchronization is required when sharing instances between threads
 * </ul>
 *
 ...
 *
 * <ul>
 *   <li>Basic types wrap primitive values with minimal overhead
 *   <li>Container types use efficient underlying collections
 *   <li>Large objects (arrays, strings) are handled with care for memory usage
 *   <li>Type signatures are validated once and cached
 * </ul>
 *
 * @see DBusType
 * @see DBusBasicType
