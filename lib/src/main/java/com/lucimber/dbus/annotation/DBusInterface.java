 ...
 * 
 * <p>This annotation is used to specify the D-Bus interface name that
 * the annotated type represents. It's used by the introspection and
 * property discovery mechanisms.</p>
 * 
 * <p>Example usage:</p>
 * <pre>{@code
